...
public class MoneyTest {
	...
	public void setUp() {
		...
		when(conv.unit_Conversion(startsWith(" ")).thenThrows (new IllegalArgumentException("Start with null"));
	}
	@Mock Convertion conv; 
	@InjectMocks private Money money =new Money(10, "EUR");
	...
	@Test (expected=java.lang.IllegalArgumentException.class)
	public void testContructorNegativeAmount() {
		m = new Money(-1, "EUR");
	}
	@Test (expected=java.lang.IllegalArgumentException.class)
